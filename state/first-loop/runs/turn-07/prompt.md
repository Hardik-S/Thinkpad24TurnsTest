...
Turn 07: Compact app shell
Instruction: Create a compact app.js. On DOMContentLoaded, fetch data/runs.json and data/hardware.json, then render simple timeline, artifacts, validation, and hardware summaries into the existing section ids. Include error text if fetch fails.
