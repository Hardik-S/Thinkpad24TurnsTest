...
This is turn 19 of 24 in the ThinkPad Build Observatory experiment.
Target file: docs/turn-19-ui-copy-tightening.md

Instruction: Write concise UI-copy tightening notes for the current static site. Identify unclear visible copy, propose exact replacement wording, and keep all suggestions for later Qwen or final Codex repair rather than editing runtime files.
...
Rules:
- Return only the complete Markdown content for docs/turn-19-ui-copy-tightening.md. No markdown fences.
